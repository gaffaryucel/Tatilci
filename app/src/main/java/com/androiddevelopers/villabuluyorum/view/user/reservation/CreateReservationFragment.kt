            ...
            with(viewModel) {
                ...
                liveDataFirebaseVilla.observe(viewLifecycleOwner) { villa ->
                    ...
                    binding.tvDeposit.text =
                        "Bu rezervasyon için ₺${nightlyRate} güvenlik depozitosu gereklidir. Bu tutar, varışınızdan önce veya giriş sırasında mülk sahibi tarafından ayrı olarak tahsil edilecektir"
